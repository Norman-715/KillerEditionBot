...
async def _(event):
    ...
    packname = f"{DEFAULTUSER}'s stickers"
    packshortname = f"{DEFAULTUSER}_Stickers"  # format: Uni_Borg_userid
    ...
    if is_a_s:
        ...
        packname = f"{DEFAULTUSER}'s STICKER PACK"
        if userid == 719877937:
            packshortname = "LUKHELE_Animated_Stickers"
        else:
